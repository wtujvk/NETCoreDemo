UE.registerUI('kityformula', function (editor, uiname) {
    ...
    var kfDialog = new UE.ui.Dialog({
        ...
        // 指定弹出层路径
        iframeUrl: editor.options.UEDITOR_HOME_URL + 'dialogs/kityformula-plugin/kityFormulaDialog.html?v=' + date.getFullYear() + (date.getMonth() + 1) + date.getDate(),
        // 编辑器实例
        editor: editor,
        // dialog 名称
        name: uiname,
    ...
    var iconUrl = editor.options.UEDITOR_HOME_URL + 'dialogs/kityformula-plugin/kf-icon.png';
