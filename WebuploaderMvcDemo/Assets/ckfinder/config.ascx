...
<script runat="server">
    ...
    public override bool CheckAuthentication()
    {
        ...
        //获取管理员信息
        //var _u = X.Component.Tools.CookieHelper.GetCookieValue("_u");
        //var Admin = new X.Project.Site.Helper.Check.AdminHelper().CheckLogin(_u);

        ////获取用户信息
        //var _s = X.Component.Tools.CookieHelper.GetCookieValue("_s");
        //var student = new X.Project.Site.Helper.Check.OStudentHelper().CheckLogin(_s);
        //if (Admin != null)
        //{
        //    return true;
        //}
    ...
    public override void SetConfig()
    {
        ...
        //if (Admin != null)
        //{
        //    BaseUrl = BaseUrl + "sys_" + Admin.Role + "/";
        //}
        //else
        //{
        //    BaseUrl = BaseUrl + "temp/";
        //}
